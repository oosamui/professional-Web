...
.visual-concept {
  background-image: url('@/assets/img/和室個室.jpg');
}
.visual-shop {
  background-image: url('@/assets/img/カフェカウンター.jpg');
}
.visual-menu {
  background-image: url('@/assets/img/メニュー.jpg');
}
.visual-information {
  background-image: url('@/assets/img/雨窓.jpg');
}
.visual-error {
